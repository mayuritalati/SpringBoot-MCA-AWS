...
<div class="jumbotron">
<form:form  modelAttribute="account" action="${pageContext.servletContext.contextPath}/spring/add"  method="POST">
<table class="table">
...
<tr>
<td>  <input  type="submit"  value="ADD ACCOUNT" class="btn btn-primary"></td>
