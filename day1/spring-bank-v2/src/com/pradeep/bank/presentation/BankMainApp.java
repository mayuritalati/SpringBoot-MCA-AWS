...
public class BankMainApp {
	...
	public static void main(String[] args) {
		...
		BankMainApp bma1=(BankMainApp)c.getBean("bankMainApp");
		BankMainApp bma2=(BankMainApp)c.getBean("bankMainApp");
		
		System.out.println(bma.hashCode());
		System.out.println(bma1.hashCode());
		System.out.println(bma2.hashCode());
